...
*This file deals with outliers and changes in consolidation in the 1930s for subsectors 

encode subsector, gen(sector_ID)
...
// Outlier in textile (investments extremely high in one year)
replace outlier = 1 if subsector == "Manufacturing: Apparel" & year == 2003

// Outlier in communications (asset totals are low in individual years; drop in other investments and wealth)  
replace outlier = 1 if subsector == "Utilities: Communications" & year == 1949
replace outlier = 1 if subsector == "Utilities: Communications" & (year == 1940 | year == 1941)

// Outlier in plastics 1999-2002 (asset totals are very high in individual years; other investments are very high)
replace outlier = 1 if subsector == "Manufacturing: Plastics" & (year == 1999 | year == 2000 | year == 2001 | year == 2002)
